...
# Model
results/feature_importance_rfr.csv results/feature_importance_xgb.csv results/summary_df results/score_plot.html : data/X_train.csv data/X_test.csv data/y_train.csv data/y_test.csv
	python src/model.py 
clean :
	rm data/raw_quebec_city_airbnb_data.csv results/*.csv results/*.html	