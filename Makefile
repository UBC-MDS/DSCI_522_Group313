...
# Model
results/feature_importance_rfr.csv results/feature_importance_xgb.csv results/summary_df results/score_plot.png : data/X_train.csv data/X_test.csv data/y_train.csv data/y_test.csv src/model.py
	python src/model.py 
clean :
