...
*Figure 1_1: Plot from exploratory data analysis displaying relationships between response (price) and some features.*
...
*Figure 1_2: Heatmap of pearson correlation coefficient between selected variables + response*
